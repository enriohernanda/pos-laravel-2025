...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/enrio.css') }}" />
...
<body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <select name="payment_method" class="form-select mt-1" id="payment_method">
    ...
    <script src="{{ asset('assets/js/enrio.js') }}"></script>
